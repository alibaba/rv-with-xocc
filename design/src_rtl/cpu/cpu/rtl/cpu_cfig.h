...
`ifdef IAHBL_ICACHE
  // `define IAHBL_ICACHE_2K
     `define IAHBL_ICACHE_4K
  // `define IAHBL_ICACHE_8K
  // `define IAHBL_ICACHE_16K
  // `define IAHBL_ICACHE_32K
  // `define IAHBL_ICACHE_64K
`endif
